...
import { getUtcDateRange } from '@/lib/booking-time'
...
export default async function AdminAppointmentsPage({
  ...
  const dateRange = selectedDate ? getUtcDateRange(selectedDate) : null
  ...
  return (
    <div className="grid gap-6">
      <section>
        ...
        <h1 className="mt-2 text-3xl font-bold text-[#0d1b3d]">Randevular</h1>
      </section>
      ...
      <AppointmentTable appointments={appointments.map(mapAppointment)} />
    </div>
  )
}
